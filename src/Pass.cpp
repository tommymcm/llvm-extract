...
static cl::list<std::string> ExtractFuncs(
    "func",
    cl::desc("Specify function to extract"),
    cl::ZeroOrMore,
...
static cl::list<std::string> ExtractRegExpFuncs(
    "rfunc",
...
static cl::list<std::string> ExtractAliases(
    "alias",
    cl::desc("Specify alias to extract"),
    cl::ZeroOrMore,
    cl::value_desc("alias"),
    cl::cat(ExtractCat));
...
// extract from the module.
static cl::list<std::string> ExtractRegExpAliases(
    "ralias",
...
static cl::list<std::string> ExtractGlobals(
    "glob",
    cl::desc("Specify global to extract"),
    cl::ZeroOrMore,
...
// extract from the module...
static cl::list<std::string> ExtractRegExpGlobals(
    "rglob",
...
static bool extract_globals(llvm::Module &M,
  ...
  for (Module::global_iterator I = M.global_begin(), E = M.global_end(); I != E;
       ++I) {
    bool Delete = deleteStuff == (bool)Named.count(&*I) && !I->isDeclaration()
  ...
  for (Module::alias_iterator I = M.alias_begin(), E = M.alias_end(); I != E;) {
    ...
    if (Delete) {
      ...
      if (FunctionType *FTy = dyn_cast<FunctionType>(Ty)) {
        Declaration = Function::Create(FTy,
        ...
        Declaration = new GlobalVariable(M,
                                         Ty,
                                         false,
                                         GlobalValue::ExternalLinkage,
                                         nullptr,
